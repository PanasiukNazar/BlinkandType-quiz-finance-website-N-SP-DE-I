const QUESTIONS = [
    {
        label: 'Was solltest du unbedingt wissen, bevor du dein Geld investierst?',
        answers: [
            'Eine klare Finanzstrategie festlegen',
            'Ungeprüften Empfehlungen blind folgen',
            'Nur investieren, weil es andere tun',
            'Ohne Analyse alles aufs Spiel setzen',
        ],
    },
    {
        label: 'Welche Anlageform gilt oft als langfristig stabil?',
        answers: [
            'Breit gestreute, risikoarme Fonds',
            'Stark schwankende Aktien',
            'Nicht regulierte Investitionen',
            'Neue Projekte ohne Historie',
        ],
    },
    {
        label: 'Welche grundlegende Methode hilft, das Risiko bei Investitionen zu senken?',
        answers: [
            'Diversifikation über verschiedene Branchen',
            'Alles in ein einzelnes Asset investieren',
            'Nur einer Informationsquelle vertrauen',
            'Finanznachrichten ignorieren',
        ],
    },
    {
        label: 'Welcher Faktor hat direkten Einfluss auf die Rendite einer Anlage?',
        answers: [
            'Marktentwicklungen und Wirtschaftslage',
    ...
    {
        label: 'Welcher Begriff steht für einen besonders hohen finanziellen Gewinn?',
        answers: [
            'Hohe Rendite',
            'Minimale Erträge',
            'Teilweiser Rückzug',
...
const startStep = {
    ...
    <div class="quiz-content">
        <div class="content">
            ...
            <h2 class="title">Interaktives Finanz-Quiz</h2>
            <h3 class="sub-title">Teste dein Wissen rund um Finanzen</h3>
            <h5 class="text">Finde heraus, wie gut du dich mit Investitionen, Sparstrategien, Risikomanagement und finanzieller Planung auskennst – mit diesem unterhaltsamen und lehrreichen Quiz.</h5>
...
const finalStep = {
    ...
    <div class="row quiz-content form-content">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12 form-block">
            <form id="quiz-form">
                <h2 class="title" style="color: #fff;">Du bist fast fertig! Speichere dein Ergebnis</h2>
                <p class="text" style="color: #fff; margin-bottom: 20px;">Fülle das Formular aus, um deine Kenntnisse zu persönlichen Finanzen, Investitionen und finanzieller Planung zu entdecken.</p>
                
                <input class="form-control" name="name" type="text" placeholder="Vorname und Nachname" required>
                ...
                <div class="checkbox" style="color: #fff;">
                    ...
                    <label for="privacyPolicy">
                        ...
                        <a class="form-link" href="terms-of-use.html" target="_blank" style="color: #fff; text-decoration: underline;">Nutzungsbedingungen</a> und stimme der Verarbeitung meiner personenbezogenen Daten zu.
                    </label>
                </div>
                ...
                <button type="submit" class="btn btn-primary w-100 py-3 first-button">Absenden</button>
            </form>
        </div>
    </div>
</div>
